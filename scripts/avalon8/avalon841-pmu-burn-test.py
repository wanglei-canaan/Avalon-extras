...
parser = argparse.ArgumentParser(description="Avalon841 PMU test script.")
...
ser = None
try:
    ser = Serial(parser.serial_port, 115200, 8, timeout=0.2)
...
# vcore_l/h(Vout) equation: x * 3.3 / 4095 = (8.49 * (1 +/-2%)) * 20 / 63
